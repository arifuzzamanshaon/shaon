...
if [ ! -d "WiFuX" ] && [ ! -f "main.py" ]; then
    ...
    git clone https://github.com/arifuzzamanshaon/WiFuX
    cd WiFuX || exit
elif [ -d "WiFuX" ]; then
    cd WiFuX || exit
fi
...
# Update Logic
if [ "\$1" == "update" ]; then
    echo -e "\033[1;32m[+] Fetching latest updates from arifuzzaman Shaon's GitHub...\033[0m"
...
echo -e "\033[1;36m     https://github.com/arifuzzamanshaon/fix-termux-root\033[0m"

...
echo "           Powered by: Arifuzzaman Shaon       "
echo "▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰"
echo -e "${R}"
...
echo -e "${C_B_GRN}▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰${R}"
echo -e "${B}${C_B_YLW}  PROTOCOL COMPLETE. MAINTAINER:Arifuzzaman Shaon${R}"
echo -e "${C_D_GRN}  [*] GitHub       : ${C_B_GRN}arifuzzamanshaon${R}"
echo -e "${C_D_GRN}  [*] Facebook     : ${C_B_GRN}thearifuzzamanshaon${R}"
echo -e "${C_D_GRN}  [*] Telegram     : ${C_B_GRN}@arifuzzamanshaon${R}"
echo -e "${C_D_GRN}  [*] TG Channel   : ${C_B_GRN}@wishaon${R}"
echo -e "${C_D_GRN}  [*] Google Search: ${C_B_GRN}Arifuzzaman Shaon${R}"
echo -e "${C_B_GRN}▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰${R}"
